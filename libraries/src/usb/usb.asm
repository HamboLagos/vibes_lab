...
; This file was generated Sat Nov 12 02:38:47 2011
;--------------------------------------------------------
	.module usb
...
_controlTransferPointer::
	.ds 2
LusbReadFifo$count$1$1==.
_usbReadFifo_PARM_2:
	.ds 1
LusbReadFifo$buffer$1$1==.
_usbReadFifo_PARM_3:
	.ds 2
LusbWriteFifo$count$1$1==.
_usbWriteFifo_PARM_2:
	.ds 1
LusbWriteFifo$buffer$1$1==.
_usbWriteFifo_PARM_3:
	.ds 2
LusbControlRead$source$1$1==.
_usbControlRead_PARM_2:
	.ds 2
LusbControlWrite$source$1$1==.
_usbControlWrite_PARM_2:
	.ds 2
LusbInitEndpointIn$maxPacketSize$1$1==.
_usbInitEndpointIn_PARM_2:
	.ds 1
LusbInitEndpointOut$maxPacketSize$1$1==.
...
_controlTransferBytesLeft::
	.ds 2
LusbStandardDeviceRequestHandler$response$1$1==.
