...
;--------------------------------------------------------
	...
	G$isrTimerInit$0$0 ==.
	C$time.c$16$1$1 ==.
;	libraries/src/wixel/time.c:16: PDATA volatile uint32 timeMs = 0;
	mov	r0,#_timeMs
	clr	a
	movx	@r0,a
	inc	r0
...
;------------------------------------------------------------
	G$getMs$0$0 ==.
	C$time.c$22$0$0 ==.
;	libraries/src/wixel/time.c:22: uint32 getMs()
;	-----------------------------------------
;	 function getMs
;	-----------------------------------------
_getMs:
	...
	ar1 = 0x01
	C$time.c$24$1$0 ==.
;	libraries/src/wixel/time.c:24: uint8 oldT4IE = T4IE; // store state of timer 4 interrupt (active or not?)
	mov	c,_T4IE
	clr	a
	rlc	a
	mov	r2,a
	C$time.c$26$1$1 ==.
;	libraries/src/wixel/time.c:26: T4IE = 0; // disable timer 4 interrupt
	clr	_T4IE
	C$time.c$27$1$1 ==.
;	libraries/src/wixel/time.c:27: time = timeMs; // copy millisecond timer count into a safe variable
	mov	r0,#_timeMs
	movx	a,@r0
	mov	r3,a
	inc	r0
	...
	mov	r6,a
	C$time.c$28$1$1 ==.
;	libraries/src/wixel/time.c:28: T4IE = oldT4IE; // restore timer 4 interrupt to its original state
	mov	a,r2
	add	a,#0xff
	mov	_T4IE,c
	C$time.c$29$1$1 ==.
;	libraries/src/wixel/time.c:29: return time; // return timer count copy
	mov	dpl,r3
	mov	dph,r4
	mov	b,r5
	mov	a,r6
...
;------------------------------------------------------------
	G$ISR_T4$0$0 ==.
	C$time.c$32$1$1 ==.
;	libraries/src/wixel/time.c:32: ISR(T4, 1)
;	-----------------------------------------
;	 function ISR_T4
;	-----------------------------------------
_ISR_T4:
	...
	mov	psw,#0x08
	C$time.c$34$1$1 ==.
;	libraries/src/wixel/time.c:34: timeMs++;
	mov	r0,#_timeMs
	movx	a,@r0
	add	a,#0x01
	movx	@r0,a
	...
	movx	@r0,a
	C$time.c$37$1$1 ==.
;	libraries/src/wixel/time.c:37: T4CC0 ^= 1;
	xrl	_T4CC0,#0x01
	pop	psw
	pop	acc
	C$time.c$38$1$1 ==.
...
;------------------------------------------------------------
	G$delayMs$0$0 ==.
	C$time.c$46$1$1 ==.
;	libraries/src/wixel/time.c:46: void delayMs(uint16 milliseconds)
;	-----------------------------------------
;	 function delayMs
;	-----------------------------------------
_delayMs:
	...
	mov	r3,dph
	C$time.c$52$1$1 ==.
;	libraries/src/wixel/time.c:52: while(milliseconds--)
00101$:
	mov	ar4,r2
	mov	ar5,r3
	dec	r2
...
00109$:
	...
	jz	00104$
	C$time.c$54$2$2 ==.
;	libraries/src/wixel/time.c:54: delayMicroseconds(250);
	mov	dpl,#0xFA
	push	ar2
	push	ar3
	lcall	_delayMicroseconds
	C$time.c$55$2$2 ==.
;	libraries/src/wixel/time.c:55: delayMicroseconds(250);
	mov	dpl,#0xFA
	lcall	_delayMicroseconds
	C$time.c$56$2$2 ==.
;	libraries/src/wixel/time.c:56: delayMicroseconds(250);
	mov	dpl,#0xFA
	lcall	_delayMicroseconds
	C$time.c$57$2$2 ==.
;	libraries/src/wixel/time.c:57: delayMicroseconds(249); // there's some overhead, so only delay by 249 here
	mov	dpl,#0xF9
	lcall	_delayMicroseconds
	pop	ar3
	pop	ar2
...
;------------------------------------------------------------
	G$timeInit$0$0 ==.
	C$time.c$67$1$1 ==.
;	libraries/src/wixel/time.c:67: void timeInit()
;	-----------------------------------------
;	 function timeInit
;	-----------------------------------------
_timeInit:
	C$time.c$70$1$1 ==.
;	libraries/src/wixel/time.c:70: T4CC0 = 187; // Reaches overflow every 1 ms (1KHz cycle)
	mov	_T4CC0,#0xBB
	C$time.c$72$1$1 ==.
;	libraries/src/wixel/time.c:72: T4IE = 1; // Enable Timer 4 interrupt.  (IEN1.T4IE=1)
	setb	_T4IE
	C$time.c$79$1$1 ==.
;	libraries/src/wixel/time.c:79: T4CTL = 0b11111110;
	mov	_T4CTL,#0xFE
	C$time.c$81$1$1 ==.
;	libraries/src/wixel/time.c:81: EA = 1; // Globally enable interrupts (IEN0.EA=1).
	setb	_EA
	C$time.c$82$1$1 ==.
	XG$timeInit$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'isrTimerInit'
;------------------------------------------------------------
;------------------------------------------------------------
	G$isrTimerInit$0$0 ==.
	C$time.c$84$1$1 ==.
;	libraries/src/wixel/time.c:84: void isrTimerInit()
;	-----------------------------------------
;	 function isrTimerInit
;	-----------------------------------------
_isrTimerInit:
	C$time.c$87$1$1 ==.
;	libraries/src/wixel/time.c:87: T3CC0 = 150; // Reaches overflow every 100us (10KHz cycle)
	mov	_T3CC0,#0x96
	C$time.c$89$1$1 ==.
;	libraries/src/wixel/time.c:89: T3IE = 1; // Enable Timer 3 interrupt.   (IEN1.T3IE=1)
	setb	_T3IE
	C$time.c$96$1$1 ==.
;	libraries/src/wixel/time.c:96: T3CTL = 0b10011110;
	mov	_T3CTL,#0x9E
	C$time.c$99$1$1 ==.
;	libraries/src/wixel/time.c:99: IP1 |= 1 << 3;
	orl	_IP1,#0x08
	C$time.c$100$1$1 ==.
;	libraries/src/wixel/time.c:100: IP0 |= 1 << 3;
	orl	_IP0,#0x08
	C$time.c$101$1$1 ==.
	XG$isrTimerInit$0$0 ==.
	ret
