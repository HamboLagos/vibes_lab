...
F:G$ISR_T4$0$0({2}DF,SV:S),Z,0,0,1,12,1
F:G$delayMs$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$timeInit$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$isrTimerInit$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:LgetMs$oldT4IE$1$1({1}SC:U),R,0,0,[r2]
S:LgetMs$time$1$1({4}SL:U),R,0,0,[r3,r4,r5,r6]
S:LdelayMs$milliseconds$1$1({2}SI:U),R,0,0,[r2,r3]
