...
; This file was generated Mon Dec 10 17:37:57 2012
;--------------------------------------------------------
	.module adc
...
;------------------------------------------------------------
	G$adcInit$0$0 ==.
	C$adc.c$5$0$0 ==.
;	libraries/src/adc/adc.c:5: void adcInit(void)
;	-----------------------------------------
;	 function adcInit
;	-----------------------------------------
_adcInit:
	...
	ar1 = 0x01
	C$adc.c$8$1$1 ==.
;	libraries/src/adc/adc.c:8: ADCIE = 0;
	clr	_ADCIE
	C$adc.c$9$1$1 ==.
;	libraries/src/adc/adc.c:9: ADCIF = 0;
	clr	_ADCIF
	C$adc.c$12$1$1 ==.
;	libraries/src/adc/adc.c:12: ADCCFG |= 0x02;    // Enble P0_1 as ADC input (A1IN)
	orl	_ADCCFG,#0x02
	C$adc.c$15$1$1 ==.
;	libraries/src/adc/adc.c:15: ADCIE = 1;
	setb	_ADCIE
	C$adc.c$16$1$1 ==.
	XG$adcInit$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$adcRead$0$0 ==.
	C$adc.c$18$1$1 ==.
;	libraries/src/adc/adc.c:18: uint16 adcRead(uint8 channel) __reentrant
;	-----------------------------------------
;	 function adcRead
;	-----------------------------------------
_adcRead:
	mov	r2,dpl
	C$adc.c$28$1$1 ==.
;	libraries/src/adc/adc.c:28: ADCIF = 0;               // Clear the flag.
	clr	_ADCIF
	C$adc.c$29$1$1 ==.
;	libraries/src/adc/adc.c:29: ADCCON3 = 0b10110000 ^ channel;
	mov	a,#0xB0
	xrl	a,r2
	mov	_ADCCON3,a
	C$adc.c$30$1$1 ==.
;	libraries/src/adc/adc.c:30: while(!ADCIF){};         // Wait for the reading to finish.
00101$:
	jnb	_ADCIF,00101$
	C$adc.c$32$1$1 ==.
;	libraries/src/adc/adc.c:32: if (ADCH & 0x80)
	mov	a,_ADCH
	jnb	acc.7,00105$
	C$adc.c$35$2$3 ==.
;	libraries/src/adc/adc.c:35: return 0;
	mov	dptr,#0x0000
	ret
00105$:
	C$adc.c$42$2$4 ==.
;	libraries/src/adc/adc.c:42: return ADC >> 4;
	mov	dpl,_ADC
	mov	a,(_ADC >> 8)
	swap	a
	xch	a,dpl
