 ...
 * be running: vibes_lab_rx_4.0.c
 *
 * \section brief_notes BRIEF NOTES
 *
 * -# Internal ADC performs 11-bit conversion every 100us
 *    (\f$11 bits \cdot 10K \frac{samples}{second} \f$ = 110Kbps data rate).
 *    - Internally, ADC result is a number 0-2047 inclusive (11 bits)
 ...
 *    - Samples are up-converted from 11-bits to 12-bits
